...
export const minikitConfig = {
	...
	miniapp: {
		...
		tagline: "Backed Stocks with Crypto",
		ogTitle: "Biequity - Backed Stocks",
		ogDescription:
			"Issue and trade tokenized equities backed by stablecoins on Base. Mint and redeem onchain.",
